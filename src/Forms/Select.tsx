    ...
    <fieldset className="relative space-y-2">
      <Combobox value={value || defaultValue} onChange={onChange}>
        ...
        <div className="relative">
          <Combobox.Button className="w-full">
            <Combobox.Input
              style={{ height, width }}
              className="w-full px-4 py-2 text-sm font-medium text-gray-600  cursor-pointer  rounded-xl bg-[#FFFFF] border border-gray-500"
              onChange={(event) => {
      ...
      {validationError && (
        <p
          ...
          className="absolute left-0 text-xs text-red-700 top-[5.5rem] "
          id="error">
